...
rtl.module("uLazarusIntegration",["System","JS","Web","Types","Classes","SysUtils"],function () {
  ...
  var $impl = $mod.$impl;
  $impl.fishJsonData = ((((((((((((("[" + 
  '{"id":"101","Notes":"To be able to work with pas2js, you need to inform the Pas2JS compiler to the PATH. For WINDOWS: go to → System → Advanced Options → Environment Variables → Edit" \n },') + 
  '{"id":"102","Notes":"Change your Operating System PATH variable → Edit"},') + 
  '{"id":"103","Notes":"Inform the the Path you want to add"},') + 
  '{"id":"109","Notes":"To be able to work with pas2js, you must install the pas2jsdsgn.lpk package, which you can find in the lazarus\/components\/pas2js\/ directory."},') + 
  ...
  '{"id":"122","Notes":"Check out the Project >> Project Options >> Compiler Commands. The variable $MakeExe(pas2js), the actual path to Pas2JS executable is not necessary anymore."},') +
  '{"id":"123","Notes":"Also you can set up some pas2js compiler arguments at Project >> Project Options >> Custom Options"},') +
