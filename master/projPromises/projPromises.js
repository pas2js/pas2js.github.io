...
rtl.module("uMain",["System","JS","Web","Classes","SysUtils"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  this.fetchImgSequentially = function () {
    var doggies = null;
    var doggyplayground = null;
    ...
    function displayimages(images) {
      function p(url) {
        ...
        doggyplayground.appendChild(docFragment);
        displayimages(images);
        return Result;
      };
      function c(url) {
        var Result = undefined;
        window.console.log("Error loading " + url);
        displayimages(images);
        return Result;
      };
      targetimage = images.shift();
      if (targetimage) {
        $impl.getImage(targetimage).then(p).catch(c);
      };
    };
    doggies = new Array("images\/g01.jpg","images\/g02.jpg","images\/g03.jpg","images\/g04.jpg","images\/g05.jpg","images\/g06.jpg","images\/g07.jpg","images\/g08.jpg","images\/g09.jpg","images\/g10.jpg","images\/g11.jpg","images\/g12.jpg","images\/g13.jpg","images\/g14.jpg","images\/g15.jpg","images\/g16.jpg");
    doggyplayground = document.getElementsByClassName("wrap").item(0);
    doggyplayground.innerHTML = "";
    displayimages(doggies);
  };
  this.FetchImgAtAll = function () {
    var doggies = null;
    var doggyplayground = null;
    function displayimagesAtAll(images) {
      var doggypromises = null;
      function r(urls) {
        var Result = undefined;
        var i = 0;
        var docFragment = null;
        ...
        var text = null;
        doggyplayground.innerHTML = "";
        for (var $l1 = 0, $end2 = rtl.getObject(urls).length - 1; $l1 <= $end2; $l1++) {
          i = $l1;
          docFragment = document.createDocumentFragment();
          div0 = document.createElement("DIV");
          div0.setAttribute("class","box");
          ...
          div0.appendChild(div_0);
          img = document.createElement("IMG");
          img.setAttribute("src","" + rtl.getObject(urls)[i]);
          div_0.appendChild(img);
          div_1 = document.createElement("DIV");
          div_1.setAttribute("class","titleBox");
          div_0.appendChild(div_1);
      ...
      function c(urls) {
        var Result = undefined;
        window.console.log("Error fetching some images: " + urls);
        return Result;
      };
      function n(element, index, anArray) {
        var Result = null;
        Result = $impl.getImage(element);
        return Result;
      };
      doggypromises = images.map(n);
      Promise.all(doggypromises).then(r).catch(c);
    };
    doggies = new Array("images\/g01.jpg","images\/g02.jpg","images\/g03.jpg","images\/g04.jpg","images\/g05.jpg","images\/g06.jpg","images\/g07.jpg","images\/g08.jpg","images\/g09.jpg","images\/g10.jpg","images\/g11.jpg","images\/g12.jpg","images\/g13.jpg","images\/g14.jpg","images\/g15.jpg","images\/g16.jpg");
    doggyplayground = document.getElementsByClassName("wrap").item(0);
  ...
  this.FetchImgAtOnce = function () {
    ...
    function displayimagesBestofBothWorlds(images) {
      ...
      function p(curPromise) {
        ...
        function p3(err) {
          var Result = undefined;
          window.console.log(("" + err) + " failed to load!");
          return Result;
        };
        resolvedPromise = resolvedPromise.then(p1).then(p2).catch(p3);
      };
      function n(element, index, anArray) {
        var Result = null;
        Result = $impl.getImage(element);
      ...
      function q(element, index, anArray) {
        var Result = false;
        p(element);
        return Result;
      };
...
rtl.module("program",["System","JS","Classes","SysUtils","Web","uMain"],function () {
  "use strict";
  var $mod = this;
  this.onBtnGroupClick = function () {
    var i = 0;
    var x = null;
    x = document.querySelectorAll(".tab-link");
    for (var $l1 = 0, $end2 = x.length - 1; $l1 <= $end2; $l1++) {
      i = $l1;
      x.item(i).classList.remove("active");
    };
    if (document.querySelector(".tab-link").classList.contains("active")) {
  ...
  this.x = null;
  $mod.$main = function () {
    $mod.x = document.querySelectorAll(".tab-link");
    for (var $l1 = 0, $end2 = $mod.x.length - 1; $l1 <= $end2; $l1++) {
      $mod.i = $l1;
      $mod.x.item($mod.i).addEventListener("click",$mod.onBtnGroupClick);
    };
    document.querySelector(".tab1").addEventListener("click",pas.uMain.fetchImgSequentially);
    document.querySelector(".tab2").addEventListener("click",pas.uMain.FetchImgAtOnce);
    document.querySelector(".tab3").addEventListener("click",pas.uMain.FetchImgAtAll);
  };
});
//# sourceMappingURL=projPromises.js.map
