...
rtl.module("WEBLib.Graphics",["System","Classes","SysUtils","Types","contnrs","Web","JS"],function () {
  ...
  rtl.createClass($mod,"TCanvas",pas.System.TObject,function () {
    ...
    this.Rectangle_ = function (X1, Y1, X2, Y2) {
    ...
    this.ApplyStroke = function () {
      var s = "";
      if (this.FContext != null) {
        s = $mod.ColorToHex(this.FPen.FColor);
        this.FContext.lineWidth = this.FPen.FWidth;
        this.FContext.strokeStyle = "#" + s;
    ...
    this.ApplyFill = function () {
      var s = "";
      if (this.FContext != null) {
        s = $mod.ColorToHex(this.FBrush.FColor);
        this.FContext.fillStyle = "#" + s;
      };
    };
    this.Rectangle = function (X1, Y1, X2, Y2) {
      this.Rectangle_(X1,Y1,X2,Y2);
    };
    this.Rectangle$1 = function (Rect) {
...
rtl.module("WEBLib.StdCtrls",["System","Classes","SysUtils","Types","Web","WEBLib.Controls","WEBLib.Graphics"],function () {
  ...
  rtl.createClass($mod,"TListBox",pas["WEBLib.Controls"].TCustomControl,function () {
    ...
    this.UpdateElement = function () {
      pas["WEBLib.Controls"].TCustomControl.UpdateElement.apply(this,arguments);
      if ((this.GetElementSelectHandle() != null) && !this.IsUpdating()) {
...
rtl.module("WEBLib.ExtCtrls",["System","Classes","SysUtils","Types","Web","math","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.Graphics"],function () {
  "use strict";
  var $mod = this;
  ...
  rtl.createClass($mod,"TSplitter",pas["WEBLib.Controls"].TCustomControl,function () {
    ...
    this.Paint = function () {
      ...
      this.GetCanvas().Rectangle$1(this.GetClientRect());
      if (this.FAlign in rtl.createSet(pas["WEBLib.Controls"].TAlign.alLeft,pas["WEBLib.Controls"].TAlign.alRight)) {
        dx = 0;
        dy = 6;
        xofs = pas.math.Floor(this.GetHeight() / 2) - 9;
        yofs = pas.math.Floor(this.GetWidth() / 2) - 1;
      };
      if (this.FAlign in rtl.createSet(pas["WEBLib.Controls"].TAlign.alTop,pas["WEBLib.Controls"].TAlign.alBottom)) {
        dx = 6;
        dy = 0;
        xofs = pas.math.Floor(this.GetWidth() / 2) - 9;
        yofs = pas.math.Floor(this.GetHeight() / 2) - 1;
      };
      this.GetCanvas().FBrush.FColor = 16777215;
      this.GetCanvas().FPen.SetColor(16777215);
      for (i = 0; i <= 2; i++) {
        this.GetCanvas().Rectangle(xofs,yofs,xofs + 2,yofs + 2);
        xofs = xofs + dx;
        yofs = yofs + dy;
      };
    };
...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms"],function () {
  ...
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    this.$init = function () {
      ...
      this.ListChildPanel = null;
      this.WebLabel2 = null;
      this.WebListBox1 = null;
      this.WebListBox2 = null;
      this.WebSplitter1 = null;
    };
    this.$final = function () {
      ...
      this.ListChildPanel = undefined;
      this.WebLabel2 = undefined;
      this.WebListBox1 = undefined;
      this.WebListBox2 = undefined;
      this.WebSplitter1 = undefined;
      pas["WEBLib.Forms"].TForm.$final.call(this);
    };
    this.LoadDFMValues = function () {
      pas["WEBLib.Forms"].TCustomForm.LoadDFMValues.apply(this,arguments);
      this.LeftPanel = pas["WEBLib.ExtCtrls"].TPanel.$create("Create$1",[this]);
      this.WebLabel1 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.LeftPanel]);
      this.WebButton1 = pas["WEBLib.StdCtrls"].TButton.$create("Create$1",[this.LeftPanel]);
      this.ClientPanel = pas["WEBLib.ExtCtrls"].TPanel.$create("Create$1",[this]);
      this.ListChildPanel = pas["WEBLib.ExtCtrls"].TPanel.$create("Create$1",[this.ClientPanel]);
      this.WebLabel2 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.ClientPanel]);
      this.WebListBox1 = pas["WEBLib.StdCtrls"].TListBox.$create("Create$1",[this.ClientPanel]);
      this.WebListBox2 = pas["WEBLib.StdCtrls"].TListBox.$create("Create$1",[this.ClientPanel]);
      this.WebSplitter1 = pas["WEBLib.ExtCtrls"].TSplitter.$create("Create$1",[this]);
      this.LeftPanel.BeginUpdate();
      this.WebLabel1.BeginUpdate();
      this.WebButton1.BeginUpdate();
      this.ClientPanel.BeginUpdate();
      this.ListChildPanel.BeginUpdate();
      this.WebLabel2.BeginUpdate();
      this.WebListBox1.BeginUpdate();
      this.WebListBox2.BeginUpdate();
      this.WebSplitter1.BeginUpdate();
      try {
        this.SetName("Form1");
        this.SetLeft(0);
        this.SetTop(0);
        ...
        this.LeftPanel.SetLeft(0);
        this.LeftPanel.SetTop(0);
        this.LeftPanel.SetWidth(150);
        this.LeftPanel.SetHeight(480);
        this.LeftPanel.SetAlign(pas["WEBLib.Controls"].TAlign.alLeft);
        this.LeftPanel.SetBorderStyle(pas["WEBLib.Controls"].TBorderStyle.bsSingle);
        this.LeftPanel.FCaption = "LeftPanel";
        this.WebLabel1.SetParent(this.LeftPanel);
        this.WebLabel1.SetName("WebLabel1");
        this.WebLabel1.SetLeft(0);
        this.WebLabel1.SetTop(0);
        this.WebLabel1.SetWidth(150);
        this.WebLabel1.SetHeight(16);
        this.WebLabel1.SetAlign(pas["WEBLib.Controls"].TAlign.alTop);
        this.WebLabel1.SetCaption("Left aligned");
        this.WebButton1.SetParent(this.LeftPanel);
        this.WebButton1.SetName("WebButton1");
        this.WebButton1.SetLeft(0);
        this.WebButton1.SetTop(455);
        this.WebButton1.SetWidth(150);
        this.WebButton1.SetHeight(25);
        this.WebButton1.SetAlign(pas["WEBLib.Controls"].TAlign.alBottom);
        this.WebButton1.SetCaption("Bottom button");
        this.WebButton1.SetTabOrder(0);
        this.WebButton1.FOnClick = rtl.createCallback(this,"WebButton1Click");
        this.ClientPanel.SetParent(this);
        this.ClientPanel.SetName("ClientPanel");
        this.ClientPanel.SetLeft(155);
        this.ClientPanel.SetTop(0);
        this.ClientPanel.SetWidth(485);
        this.ClientPanel.SetHeight(480);
        this.ClientPanel.SetAlign(pas["WEBLib.Controls"].TAlign.alClient);
        this.ClientPanel.SetBorderStyle(pas["WEBLib.Controls"].TBorderStyle.bsSingle);
        this.ClientPanel.FCaption = "ClientPanel";
        this.ListChildPanel.SetParent(this.ClientPanel);
        this.ListChildPanel.SetName("ListChildPanel");
        this.ListChildPanel.SetLeft(0);
        this.ListChildPanel.SetTop(0);
        this.ListChildPanel.SetWidth(485);
        this.ListChildPanel.SetHeight(249);
        this.ListChildPanel.SetAlign(pas["WEBLib.Controls"].TAlign.alTop);
        this.ListChildPanel.SetBorderStyle(pas["WEBLib.Controls"].TBorderStyle.bsSingle);
        this.ListChildPanel.FCaption = "ListChildPanel";
        this.WebLabel2.SetParent(this.ListChildPanel);
        this.WebLabel2.SetName("WebLabel2");
        this.WebLabel2.SetLeft(0);
        this.WebLabel2.SetTop(0);
        this.WebLabel2.SetWidth(485);
        ...
        this.WebLabel2.SetCaption("Top aligned child panel");
        this.WebListBox1.SetParent(this.ListChildPanel);
        this.WebListBox1.SetName("WebListBox1");
        this.WebListBox1.SetLeft(364);
        this.WebListBox1.SetTop(16);
        this.WebListBox1.SetWidth(121);
        this.WebListBox1.SetHeight(233);
        this.WebListBox1.SetAlign(pas["WEBLib.Controls"].TAlign.alRight);
        this.WebListBox1.SetItemIndex(-1);
        this.WebListBox1.FItems.BeginUpdate();
        try {
          this.WebListBox1.FItems.Clear();
          this.WebListBox1.FItems.Add("Right aligned");
        } finally {
          this.WebListBox1.FItems.EndUpdate();
        };
        this.WebListBox1.SetTabOrder(0);
        this.WebListBox2.SetParent(this.ListChildPanel);
        this.WebListBox2.SetName("WebListBox2");
        this.WebListBox2.SetLeft(0);
        this.WebListBox2.SetTop(16);
        this.WebListBox2.SetWidth(121);
        this.WebListBox2.SetHeight(233);
        this.WebListBox2.SetAlign(pas["WEBLib.Controls"].TAlign.alLeft);
        this.WebListBox2.SetItemIndex(-1);
        this.WebListBox2.FItems.BeginUpdate();
        try {
          this.WebListBox2.FItems.Clear();
          this.WebListBox2.FItems.Add("Left aligned");
        } finally {
          this.WebListBox2.FItems.EndUpdate();
        };
        this.WebListBox2.SetTabOrder(1);
        this.WebSplitter1.SetParent(this);
        this.WebSplitter1.SetName("WebSplitter1");
        this.WebSplitter1.SetLeft(150);
        this.WebSplitter1.SetTop(0);
        this.WebSplitter1.SetWidth(5);
        this.WebSplitter1.SetHeight(480);
        this.WebSplitter1.SetAlign(pas["WEBLib.Controls"].TAlign.alLeft);
        this.WebSplitter1.SetColor(15790320);
      } finally {
        this.LeftPanel.EndUpdate();
        this.WebLabel1.EndUpdate();
        this.WebButton1.EndUpdate();
        this.ClientPanel.EndUpdate();
        this.ListChildPanel.EndUpdate();
        this.WebLabel2.EndUpdate();
        this.WebListBox1.EndUpdate();
        this.WebListBox2.EndUpdate();
        this.WebSplitter1.EndUpdate();
      };
    };
