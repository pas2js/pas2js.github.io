...
rtl.module("uSJCL",["System","Types","JS","Web"],function () {
  "use strict";
  var $mod = this;
  rtl.recNewT($mod,"JSCipherParams",function () {
    this.$eq = function (b) {
      return (this.v === b.v) && (this.iter === b.iter) && (this.ks === b.ks) && (this.ts === b.ts) && (this.mode === b.mode) && (this.adata === b.adata) && (this.cipher === b.cipher) && (this.salt === b.salt);
    };
  ...
  rtl.createClass($mod,"TJSCipherParams",pas.System.TObject,function () {
  });
  rtl.createClass($mod,"TJSCipherEncryptParams",$mod.TJSCipherParams,function () {
  });
  rtl.createClass($mod,"TJSCipherEncrypted",$mod.TJSCipherEncryptParams,function () {
  });
});
rtl.module("MainView",["System","Classes","JS","Web","uSJCL"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  rtl.createClass($mod,"TSJCL",pas.System.TObject,function () {
    this.$init = function () {
      pas.System.TObject.$init.call(this);
      this.param = pas.uSJCL.JSCipherParams.$new();
      this.parsedMessage = null;
      this.encryptedMessage = null;
    };
    this.$final = function () {
      this.param = undefined;
      this.parsedMessage = undefined;
      this.encryptedMessage = undefined;
    ...
    this.doEncrypt = function (e) {
      var properties = "";
      var fieldnames = ["mode","iter","ks","ts","v","cipher","adata","salt"];
      var encryptedMessageWithoutParameters = "";
      if (document.querySelector("#plaintext").value === "") return;
      this.param.mode = "ccm";
      this.param.iter = 1000;
      this.param.ks = 128;
      this.param.ts = 64;
      this.param.v = 1;
      this.param.cipher = "aes";
      this.param.adata = "";
      this.param.salt = "myGeneratedSalt";
      this.encryptedMessage = sjcl.json.encrypt(document.querySelector("#password").value,document.querySelector("#plaintext").value,pas.uSJCL.JSCipherParams.$clone(this.param));
      this.parsedMessage = this.getListParsed();
      document.querySelector("#ciphertext").value = this.getListToString();
      for (var $in1 = fieldnames, $l2 = 0, $end3 = rtl.length($in1) - 1; $l2 <= $end3; $l2++) {
        properties = $in1[$l2];
        pas.JS.JSDelete(this.parsedMessage,properties);
      };
      encryptedMessageWithoutParameters = this.getListToString();
      document.querySelector("#plaintext").value = "";
      document.querySelector("#shortciphertext").value = encryptedMessageWithoutParameters;
    };
    this.doDecrypt = function (e) {
      var messageWithParameters = "";
      $impl.JSExtend(this.parsedMessage,this.param);
      messageWithParameters = this.getListToString();
      sjcl.json.decrypt(document.querySelector("#password").value,messageWithParameters);
      document.querySelector("#plaintext").value = sjcl.json.decrypt(document.querySelector("#password").value,messageWithParameters);
    };
    this.getListParsed = function () {
      var $Self = this;
      var Result = null;
      Result = JSON.parse($Self.encryptedMessage);
      return Result;
    };
    this.getListToString = function () {
      var $Self = this;
      var Result = "";
      Result = JSON.stringify($Self.parsedMessage);
      return Result;
    };
    this.Create$1 = function () {
      ...
      var decrypt = null;
      var span_0 = null;
      var pciphertext = null;
      var h2_1 = null;
      var label_1 = null;
      var ciphertext = null;
      var div_2 = null;
      var sciphertext = null;
      var h2_2 = null;
      var label_2 = null;
      var shortciphertext = null;
    ...
    this.InitializeObject = function () {
      ...
      document.querySelector("#plaintext").value = "myMessage";
      this.bindEvent(document.querySelector("#encrypt"),"click",rtl.createCallback(this,"doEncrypt"));
      this.bindEvent(document.querySelector("#decrypt"),"click",rtl.createCallback(this,"doDecrypt"));
    };
    var $r = this.$rtti;
...
rtl.module("program",["System","MainView"],function () {
  "use strict";
  var $mod = this;
  this.FMainView = null;
  $mod.$main = function () {
    $mod.FMainView = pas.MainView.TSJCL.$create("Create$1");
