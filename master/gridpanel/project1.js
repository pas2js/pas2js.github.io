...
rtl.module("WEBLib.Controls",["System","Classes","SysUtils","JS","Types","Web","WEBLib.Graphics"],function () {
  ...
  rtl.createClass($mod,"TControl",pas.Classes.TComponent,function () {
    ...
    this.SetControlPosition = function (aValue) {
      if (this.FControlPosition !== aValue) {
        this.FControlPosition = aValue;
        this.UpdateElementSize();
        this.RecreateCanvas();
        this.InternalResize();
      };
...
rtl.module("WEBLib.ExtCtrls",["System","Classes","SysUtils","Types","Web","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.Graphics"],function () {
  ...
  rtl.createClass($mod,"TControlCollectionItem",pas.Classes.TCollectionItem,function () {
    ...
    $r.addProperty("Control",0,pas["WEBLib.Controls"].$rtti["TCustomControl"],"FControl","FControl");
  });
  ...
  rtl.createClass($mod,"TGridPanel",pas["WEBLib.Controls"].TCustomControl,function () {
    ...
    this.CreateTable = function () {
      ...
      for (var $l1 = 0, $end2 = this.FRowCollection.GetCount() - 1; $l1 <= $end2; $l1++) {
        ...
        if (this.FRowCollection.GetItem$1(j).FElementClassName !== "") row.setAttribute("class",this.FRowCollection.GetItem$1(j).FElementClassName);
        ...
        for (var $l4 = 0, $end5 = this.FColumnCollection.GetCount() - 1; $l4 <= $end5; $l4++) {
          ...
          if (this.FColumnCollection.GetItem$1(i).FElementClassName !== "") cell.setAttribute("class",this.FColumnCollection.GetItem$1(i).FElementClassName);
          ...
          if (j === 0) cell.setAttribute("width",this.FColumnCollection.GetItem$1(i).WidthAttribute());
    ...
    this.UpdateTable = function () {
      ...
      for (var $l1 = 0, $end2 = this.FControlCollection.GetCount() - 1; $l1 <= $end2; $l1++) {
        ...
        if (this.FControlCollection.GetItem$1(k).FControl != null) {
          ...
          control.SetControlPosition(pas["WEBLib.Controls"].TControlPosition.cpRelative);
          ...
          document.getElementById(destid).appendChild(fragment);
        };
      };
    };
    this.CreateElement = function () {
    ...
    $r.addProperty("GridLineColor",0,rtl.longint,"FGridLineColor","FGridLineColor");
...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms"],function () {
  ...
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    ...
    this.LoadDFMValues = function () {
      ...
      this.WebGridPanel1 = pas["WEBLib.ExtCtrls"].TGridPanel.$create("Create$1",[this]);
      this.WebLabel1 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebGridPanel1]);
      this.WebLabel2 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebGridPanel1]);
      this.WebLabel3 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebGridPanel1]);
      this.WebLabel4 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebGridPanel1]);
      this.WebEdit1 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebGridPanel1]);
      this.WebButton1 = pas["WEBLib.StdCtrls"].TButton.$create("Create$1",[this.WebGridPanel1]);
      this.WebEdit2 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebGridPanel1]);
      this.WebButton2 = pas["WEBLib.StdCtrls"].TButton.$create("Create$1",[this.WebGridPanel1]);
      this.WebEdit3 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebGridPanel1]);
      this.WebButton3 = pas["WEBLib.StdCtrls"].TButton.$create("Create$1",[this.WebGridPanel1]);
      this.WebEdit4 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebGridPanel1]);
      this.WebButton4 = pas["WEBLib.StdCtrls"].TButton.$create("Create$1",[this.WebGridPanel1]);
      this.WebPanel1 = pas["WEBLib.ExtCtrls"].TPanel.$create("Create$1",[this]);
      this.WebLabel6 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebPanel1]);
      this.WebImageControl1 = pas["WEBLib.ExtCtrls"].TImageControl.$create("Create$1",[this.WebPanel1]);
      this.WebLabel5.BeginUpdate();
      this.WebGridPanel1.BeginUpdate();
      ...
      this.WebEdit2.BeginUpdate();
      this.WebButton2.BeginUpdate();
      this.WebEdit3.BeginUpdate();
      this.WebButton3.BeginUpdate();
      this.WebEdit4.BeginUpdate();
      this.WebButton4.BeginUpdate();
      ...
      try {
        ...
        this.WebLabel5.SetLeft(70);
        this.WebLabel5.SetTop(32);
        this.WebLabel5.SetWidth(186);
        this.WebLabel5.SetHeight(23);
        this.WebLabel5.SetCaption("Grid Panel component");
        this.WebLabel5.FFont.FCharset = 1;
        this.WebLabel5.FFont.SetColor(0);
        this.WebLabel5.FFont.SetHeight(-19);
        this.WebLabel5.FFont.SetName("Tahoma");
        this.WebLabel5.FFont.SetStyle({});
        this.WebLabel5.FParentFont = false;
        var $with1 = this.WebGridPanel1;
        $with1.SetParent(this);
        $with1.SetName("WebGridPanel1");
        $with1.SetLeft(67);
        $with1.SetTop(64);
        $with1.SetWidth(510);
        $with1.SetHeight(217);
        $with1.SetColor(16777215);
        $with1.FGridLineWidth = 1;
        $with1.FGridLineColor = 12632256;
        $with1.FColumnCollection.Clear();
        var $with2 = $with1.FColumnCollection.Add$1();
        $with2.FMarginLeft = 3;
        $with2.FMarginRight = 3;
        $with2.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with2.FValue = 25;
        var $with3 = $with1.FColumnCollection.Add$1();
        $with3.FAlignment = pas.Classes.TAlignment.taCenter;
        $with3.FMarginLeft = 3;
        $with3.FMarginRight = 3;
        $with3.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with3.FValue = 50;
        var $with4 = $with1.FColumnCollection.Add$1();
        $with4.FAlignment = pas.Classes.TAlignment.taRightJustify;
        $with4.FMarginLeft = 3;
        $with4.FMarginRight = 3;
        $with4.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with4.FValue = 25;
        $with1.FControlCollection.Clear();
        var $with5 = $with1.FControlCollection.Add$1();
        $with5.FColumn = 0;
        $with5.FRow = 0;
        $with5.FControl = this.WebLabel1;
        var $with6 = $with1.FControlCollection.Add$1();
        $with6.FColumn = 0;
        $with6.FRow = 0;
        $with6.FControl = this.WebEdit1;
        var $with7 = $with1.FControlCollection.Add$1();
        $with7.FColumn = 0;
        $with7.FRow = 0;
        $with7.FControl = this.WebButton1;
        var $with8 = $with1.FControlCollection.Add$1();
        $with8.FColumn = 0;
        $with8.FRow = 0;
        $with8.FControl = this.WebLabel2;
        var $with9 = $with1.FControlCollection.Add$1();
        $with9.FColumn = 0;
        $with9.FRow = 0;
        $with9.FControl = this.WebEdit2;
        var $with10 = $with1.FControlCollection.Add$1();
        $with10.FColumn = 0;
        $with10.FRow = 0;
        $with10.FControl = this.WebButton2;
        var $with11 = $with1.FControlCollection.Add$1();
        $with11.FColumn = 0;
        $with11.FRow = 0;
        $with11.FControl = this.WebLabel3;
        var $with12 = $with1.FControlCollection.Add$1();
        $with12.FColumn = 0;
        $with12.FRow = 0;
        $with12.FControl = this.WebEdit3;
        var $with13 = $with1.FControlCollection.Add$1();
        $with13.FColumn = 0;
        $with13.FRow = 0;
        $with13.FControl = this.WebButton3;
        var $with14 = $with1.FControlCollection.Add$1();
        $with14.FColumn = 0;
        $with14.FRow = 0;
        $with14.FControl = this.WebLabel4;
        var $with15 = $with1.FControlCollection.Add$1();
        $with15.FColumn = 0;
        $with15.FRow = 0;
        $with15.FControl = this.WebEdit4;
        var $with16 = $with1.FControlCollection.Add$1();
        $with16.FColumn = 0;
        $with16.FRow = 0;
        $with16.FControl = this.WebButton4;
        $with1.FRowCollection.Clear();
        var $with17 = $with1.FRowCollection.Add$1();
        $with17.FAlignment = pas["WEBLib.ExtCtrls"].TVerticalAlignment.vaCenter;
        $with17.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with17.FValue = 25;
        var $with18 = $with1.FRowCollection.Add$1();
        $with18.FAlignment = pas["WEBLib.ExtCtrls"].TVerticalAlignment.vaCenter;
        $with18.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with18.FValue = 25;
        var $with19 = $with1.FRowCollection.Add$1();
        $with19.FAlignment = pas["WEBLib.ExtCtrls"].TVerticalAlignment.vaCenter;
        $with19.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with19.FValue = 25;
        var $with20 = $with1.FRowCollection.Add$1();
        $with20.FAlignment = pas["WEBLib.ExtCtrls"].TVerticalAlignment.vaCenter;
        $with20.FSizeStyle = pas["WEBLib.Controls"].TSizeStyle.ssPercent;
        $with20.FValue = 25;
        this.WebLabel1.SetParent(this.WebGridPanel1);
        this.WebLabel1.SetName("WebLabel1");
        this.WebLabel1.SetLeft(5);
        this.WebLabel1.SetTop(19);
        this.WebLabel1.SetWidth(66);
        this.WebLabel1.SetHeight(16);
        this.WebLabel1.SetCaption("First name:");
        this.WebLabel2.SetParent(this.WebGridPanel1);
        this.WebLabel2.SetName("WebLabel2");
        this.WebLabel2.SetLeft(5);
        this.WebLabel2.SetTop(73);
        this.WebLabel2.SetWidth(64);
        this.WebLabel2.SetHeight(16);
        this.WebLabel2.SetCaption("Last name:");
        this.WebLabel3.SetParent(this.WebGridPanel1);
        this.WebLabel3.SetName("WebLabel3");
        this.WebLabel3.SetLeft(5);
        this.WebLabel3.SetTop(127);
        this.WebLabel3.SetWidth(36);
        this.WebLabel3.SetHeight(16);
        this.WebLabel3.SetCaption("Email:");
        this.WebLabel4.SetParent(this.WebGridPanel1);
        this.WebLabel4.SetName("WebLabel4");
        this.WebLabel4.SetLeft(5);
        this.WebLabel4.SetTop(181);
        this.WebLabel4.SetWidth(49);
        this.WebLabel4.SetHeight(16);
        this.WebLabel4.SetCaption("Country:");
        this.WebEdit1.SetParent(this.WebGridPanel1);
        this.WebEdit1.SetName("WebEdit1");
        this.WebEdit1.SetLeft(156);
        this.WebEdit1.SetTop(15);
        this.WebEdit1.SetWidth(196);
        this.WebEdit1.SetHeight(24);
        this.WebEdit1.SetTabOrder(0);
        this.WebEdit1.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebEdit1.SetWidthPercent(80);
        this.WebButton1.SetParent(this.WebGridPanel1);
        this.WebButton1.SetName("WebButton1");
        this.WebButton1.SetLeft(434);
        this.WebButton1.SetTop(12);
        this.WebButton1.SetWidth(70);
        this.WebButton1.SetHeight(30);
        this.WebButton1.SetCaption("Edit");
        this.WebButton1.SetTabOrder(1);
        this.WebButton1.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebButton1.SetWidthPercent(60);
        this.WebEdit2.SetParent(this.WebGridPanel1);
        this.WebEdit2.SetName("WebEdit2");
        this.WebEdit2.SetLeft(156);
        this.WebEdit2.SetTop(69);
        this.WebEdit2.SetWidth(196);
        this.WebEdit2.SetHeight(24);
        this.WebEdit2.SetTabOrder(2);
        this.WebEdit2.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebEdit2.SetWidthPercent(80);
        this.WebButton2.SetParent(this.WebGridPanel1);
        this.WebButton2.SetName("WebButton2");
        this.WebButton2.SetLeft(434);
        this.WebButton2.SetTop(66);
        this.WebButton2.SetWidth(70);
        this.WebButton2.SetHeight(30);
        this.WebButton2.SetCaption("Edit");
        this.WebButton2.SetTabOrder(3);
        this.WebButton2.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebButton2.SetWidthPercent(60);
        this.WebEdit3.SetParent(this.WebGridPanel1);
        this.WebEdit3.SetName("WebEdit3");
        this.WebEdit3.SetLeft(156);
        this.WebEdit3.SetTop(123);
        this.WebEdit3.SetWidth(196);
        this.WebEdit3.SetHeight(24);
        this.WebEdit3.SetTabOrder(4);
        this.WebEdit3.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebEdit3.SetWidthPercent(80);
        this.WebButton3.SetParent(this.WebGridPanel1);
        this.WebButton3.SetName("WebButton3");
        this.WebButton3.SetLeft(434);
        this.WebButton3.SetTop(120);
        this.WebButton3.SetWidth(70);
        this.WebButton3.SetHeight(30);
        this.WebButton3.SetCaption("Edit");
        this.WebButton3.SetTabOrder(5);
        this.WebButton3.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebButton3.SetWidthPercent(60);
        this.WebEdit4.SetParent(this.WebGridPanel1);
        this.WebEdit4.SetName("WebEdit4");
        this.WebEdit4.SetLeft(156);
        this.WebEdit4.SetTop(177);
        this.WebEdit4.SetWidth(196);
        this.WebEdit4.SetHeight(24);
        this.WebEdit4.SetTabOrder(6);
        this.WebEdit4.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebEdit4.SetWidthPercent(80);
        this.WebButton4.SetParent(this.WebGridPanel1);
        this.WebButton4.SetName("WebButton4");
        this.WebButton4.SetLeft(434);
        this.WebButton4.SetTop(174);
        this.WebButton4.SetWidth(70);
        this.WebButton4.SetHeight(30);
        this.WebButton4.SetCaption("Edit");
        this.WebButton4.SetTabOrder(7);
        this.WebButton4.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebButton4.SetWidthPercent(60);
        this.WebPanel1.SetParent(this);
        this.WebPanel1.SetName("WebPanel1");
        this.WebPanel1.SetLeft(64);
        this.WebPanel1.SetTop(304);
        ...
        this.WebLabel6.SetParent(this.WebPanel1);
        this.WebLabel6.SetName("WebLabel6");
        this.WebLabel6.SetLeft(3);
        this.WebLabel6.SetTop(29);
        this.WebLabel6.SetWidth(397);
        this.WebLabel6.SetHeight(32);
        this.WebLabel6.SetCaption("The GridPanel allows easy control of alignment and sizing of controls within the panel.");
        this.WebLabel6.FWordWrap = true;
        this.WebLabel6.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        ...
        this.WebEdit2.EndUpdate();
        this.WebButton2.EndUpdate();
        this.WebEdit3.EndUpdate();
        this.WebButton3.EndUpdate();
        this.WebEdit4.EndUpdate();
        this.WebButton4.EndUpdate();
