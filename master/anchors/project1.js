...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms"],function () {
  ...
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    ...
    this.LoadDFMValues = function () {
      ...
      this.WebLabel1 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebPanel1]);
      this.WebLabel2 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebPanel1]);
      this.WebEdit1 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebPanel1]);
      this.WebEdit2 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this.WebPanel1]);
      this.WebMemo1 = pas["WEBLib.StdCtrls"].TMemo.$create("Create$1",[this.WebPanel1]);
      this.WebPanel2 = pas["WEBLib.ExtCtrls"].TPanel.$create("Create$1",[this]);
      this.WebLabel6 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$1",[this.WebPanel2]);
      this.WebImageControl1 = pas["WEBLib.ExtCtrls"].TImageControl.$create("Create$1",[this.WebPanel2]);
      ...
      try {
        ...
        this.WebPanel1.SetLeft(24);
        this.WebPanel1.SetTop(24);
        this.WebPanel1.SetWidth(410);
        this.WebPanel1.SetHeight(281);
        this.WebPanel1.SetAnchors(rtl.createSet(pas["WEBLib.Controls"].TAnchorKind.akLeft,pas["WEBLib.Controls"].TAnchorKind.akTop,pas["WEBLib.Controls"].TAnchorKind.akRight,pas["WEBLib.Controls"].TAnchorKind.akBottom));
        this.WebPanel1.SetBorderStyle(pas["WEBLib.Controls"].TBorderStyle.bsSingle);
        this.WebPanel1.FCaption = "WebPanel1";
        this.WebLabel1.SetParent(this.WebPanel1);
        this.WebLabel1.SetName("WebLabel1");
        this.WebLabel1.SetLeft(24);
        this.WebLabel1.SetTop(24);
        this.WebLabel1.SetWidth(120);
        this.WebLabel1.SetHeight(16);
        this.WebLabel1.SetCaption("Left anchored label 1");
        this.WebLabel2.SetParent(this.WebPanel1);
        this.WebLabel2.SetName("WebLabel2");
        this.WebLabel2.SetLeft(24);
        this.WebLabel2.SetTop(64);
        this.WebLabel2.SetWidth(120);
        this.WebLabel2.SetHeight(16);
        this.WebLabel2.SetCaption("Left anchored label 2");
        this.WebEdit1.SetParent(this.WebPanel1);
        this.WebEdit1.SetName("WebEdit1");
        this.WebEdit1.SetLeft(268);
        this.WebEdit1.SetTop(21);
        this.WebEdit1.SetWidth(121);
        this.WebEdit1.SetHeight(24);
        this.WebEdit1.SetAnchors(rtl.createSet(pas["WEBLib.Controls"].TAnchorKind.akTop,pas["WEBLib.Controls"].TAnchorKind.akRight));
        this.WebEdit1.SetTabOrder(0);
        this.WebEdit1.SetText("Anchor right");
        this.WebEdit2.SetParent(this.WebPanel1);
        this.WebEdit2.SetName("WebEdit2");
        this.WebEdit2.SetLeft(268);
        this.WebEdit2.SetTop(61);
        this.WebEdit2.SetWidth(121);
        this.WebEdit2.SetHeight(24);
        this.WebEdit2.SetAnchors(rtl.createSet(pas["WEBLib.Controls"].TAnchorKind.akLeft,pas["WEBLib.Controls"].TAnchorKind.akTop,pas["WEBLib.Controls"].TAnchorKind.akRight));
        this.WebEdit2.SetTabOrder(1);
        this.WebEdit2.SetText("Anchor left,right");
        this.WebMemo1.SetParent(this.WebPanel1);
        this.WebMemo1.SetName("WebMemo1");
        this.WebMemo1.SetLeft(24);
        this.WebMemo1.SetTop(120);
        this.WebMemo1.SetWidth(365);
        this.WebMemo1.SetHeight(142);
        this.WebMemo1.SetAnchors(rtl.createSet(pas["WEBLib.Controls"].TAnchorKind.akLeft,pas["WEBLib.Controls"].TAnchorKind.akTop,pas["WEBLib.Controls"].TAnchorKind.akRight,pas["WEBLib.Controls"].TAnchorKind.akBottom));
        this.WebMemo1.SetAutoSize(false);
        this.WebMemo1.FLines.BeginUpdate();
        try {
          this.WebMemo1.FLines.Clear();
          this.WebMemo1.FLines.Add("Left,Top \\\/ Right,Bottom anchored memo");
        } finally {
          this.WebMemo1.FLines.EndUpdate();
        };
        this.WebMemo1.SetSelLength(0);
        this.WebMemo1.SetSelStart(39);
        this.WebMemo1.SetTabOrder(2);
        this.WebPanel2.SetParent(this);
        this.WebPanel2.SetName("WebPanel2");
        this.WebPanel2.SetLeft(24);
        this.WebPanel2.SetTop(404);
        this.WebPanel2.SetWidth(513);
        this.WebPanel2.SetHeight(89);
        this.WebPanel2.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebPanel2.SetWidthPercent(80);
        this.WebPanel2.SetBorderStyle(pas["WEBLib.Controls"].TBorderStyle.bsSingle);
        this.WebLabel6.SetParent(this.WebPanel2);
        this.WebLabel6.SetName("WebLabel6");
        this.WebLabel6.SetLeft(3);
        this.WebLabel6.SetTop(29);
        this.WebLabel6.SetWidth(445);
        this.WebLabel6.SetHeight(32);
        this.WebLabel6.SetCaption("Self demo shows anchoring of controls on the web form. Resize the browser window to see the effect.");
        this.WebLabel6.FWordWrap = true;
        this.WebLabel6.SetWidthStyle(pas["WEBLib.Controls"].TSizeStyle.ssPercent);
        this.WebImageControl1.SetParent(this.WebPanel2);
