...
rtl.module("WEBLib.Forms",["System","Classes","SysUtils","JS","Types","Web","WEBLib.Graphics","WEBLib.Controls"],function () {
  ...
  rtl.createClass($mod,"TCustomForm",pas["WEBLib.Controls"].TWinControl,function () {
    ...
    this.SetModalResult = function (Value) {
      ...
      if (this.FModalResult !== $mod.TModalResult.mrNone) this.Close();
    };
    ...
    this.Show = function () {
      var I = 0;
      if (this.FFormFileName === "") document.body.appendChild(this.FContainer);
    ...
    this.ShowModal = function (AProc) {
      var Result = 0;
      Result = 0;
      this.FModalProc = AProc;
      this.SetModalResult($mod.TModalResult.mrNone);
      this.Show();
      return Result;
    };
    this.CreateInitialize = function () {
    ...
    this.CreateNew$1 = function (AProc) {
  ...
  rtl.createClass($mod,"TApplication",pas["WEBLib.Controls"].TControl,function () {
    ...
    this.DoFormLoad = function (Event) {
      ...
      if (!this.FMainForm.FPopup) {
        document.body.innerHTML = this.FLastReq.responseText}
       else {
        ...
        eh.appendChild(span);
        span.innerHTML = this.FLastReq.responseText;
...
rtl.module("Unit2",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TForm2",pas["WEBLib.Forms"].TForm,function () {
    this.$init = function () {
    ...
    this.LoadDFMValues = function () {
      ...
      this.frm2Edit = pas["WEBLib.StdCtrls"].TEdit.$create("Create$1",[this]);
      this.WebLabel1.BeginUpdate();
      this.WebLabel2.BeginUpdate();
      this.WebButton2.BeginUpdate();
      this.frm2Edit.BeginUpdate();
      try {
        this.SetName("Form2");
        this.SetLeft(0);
        this.SetTop(0);
        ...
        this.WebLabel1.SetTop(32);
        this.WebLabel1.SetWidth(90);
        this.WebLabel1.SetHeight(35);
        this.WebLabel1.SetCaption("Form 2");
        this.WebLabel1.FFont.FCharset = 1;
        this.WebLabel1.FFont.SetColor(255);
        this.WebLabel1.FFont.SetHeight(-29);
        ...
        this.WebLabel2.SetLeft(40);
        this.WebLabel2.SetTop(123);
        this.WebLabel2.SetWidth(75);
        this.WebLabel2.SetHeight(16);
        this.WebLabel2.SetCaption("Preset value:");
        this.WebButton2.SetParent(this);
        this.WebButton2.SetName("WebButton2");
        this.WebButton2.SetLeft(40);
        this.WebButton2.SetTop(184);
        this.WebButton2.SetWidth(281);
        this.WebButton2.SetHeight(57);
        this.WebButton2.SetCaption("Close form");
        this.WebButton2.FOnClick = rtl.createCallback(this,"WebButton2Click");
        this.WebButton2.SetTabOrder(0);
        this.frm2Edit.SetParent(this);
        this.frm2Edit.SetName("frm2Edit");
        this.frm2Edit.SetLeft(121);
        this.frm2Edit.SetTop(120);
        this.frm2Edit.SetWidth(209);
        this.frm2Edit.SetHeight(24);
        this.frm2Edit.SetTabOrder(1);
      } finally {
        this.WebLabel1.EndUpdate();
        this.WebLabel2.EndUpdate();
        this.WebButton2.EndUpdate();
        this.frm2Edit.EndUpdate();
      };
    };
  ...
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    ...
    this.LoadDFMValues = function () {
      ...
      try {
        ...
        this.WebLabel1.SetWidth(90);
        this.WebLabel1.SetHeight(35);
        this.WebLabel1.SetCaption("Form 1");
        this.WebLabel1.FFont.FCharset = 1;
        this.WebLabel1.FFont.SetColor(255);
        this.WebLabel1.FFont.SetHeight(-29);
        this.WebLabel1.FFont.SetName("Tahoma");
        ...
        this.WebButton1.SetLeft(40);
        this.WebButton1.SetTop(184);
        this.WebButton1.SetWidth(281);
        this.WebButton1.SetHeight(57);
        this.WebButton1.SetCaption("Click here to open the second form");
        ...
        this.WebEdit1.SetLeft(40);
        this.WebEdit1.SetTop(88);
        this.WebEdit1.SetWidth(177);
        this.WebEdit1.SetHeight(24);
        this.WebEdit1.SetTabOrder(1);
        this.WebEdit1.SetText("sample text edit");
        this.WebCheckBox1.SetParent(this);
        this.WebCheckBox1.SetName("WebCheckBox1");
        this.WebCheckBox1.SetLeft(40);
        this.WebCheckBox1.SetTop(154);
        this.WebCheckBox1.SetWidth(177);
        this.WebCheckBox1.SetHeight(17);
        this.WebCheckBox1.SetCaption("Show form as popup");
        this.WebCheckBox1.SetState(pas["WEBLib.StdCtrls"].TCheckBoxState.cbUnchecked);
        this.WebCheckBox1.SetTabOrder(2);
        ...
        this.WebLabel6.SetWidth(479);
        this.WebLabel6.SetHeight(32);
        this.WebLabel6.SetCaption("Demo showing a web application consisting of two form files and showing the form either on top of the main form or launching it as a new web page");
    ...
    this.WebButton1Click = function (Sender) {
      ...
      function AfterShowModal(AValue) {
        pas.System.Writeln("Form 2 closed with new value:" + newform.frm2Edit.GetText());
        Self.WebEdit1.SetText(newform.frm2Edit.GetText());
      };
      function AfterCreate(AForm) {
        rtl.as(AForm,pas.Unit2.TForm2).frm2Edit.SetText(Self.WebEdit1.GetText());
      };
      newform = pas.Unit2.TForm2.$create("CreateNew$1",[AfterCreate]);
      newform.FPopup = Self.WebCheckBox1.GetChecked();
      newform.ShowModal(AfterShowModal);
    };
  });
  this.Form1 = null;
},["Unit2"]);
rtl.module("program",["System","JS","Classes","SysUtils","Web","WEBLib.Forms","WEBLib.Runner","Unit1","Unit2"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
