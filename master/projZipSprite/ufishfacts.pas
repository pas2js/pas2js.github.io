...
uses
  SysUtils, Classes, JS, Web, Types, Math, uMain, uResources;

type
  TFishRecord = record
    Category     : string; external name 'Category';
    Common_Name  : string; external name 'Common_Name';
    Length_Cm    : string; external name 'Length_Cm';
    Length_In    : string; external name 'Length_In';
    Notes        : string; external name 'Notes';
    Species_Name : string; external name 'Species_Name';
    Species_No   : string; external name 'Species_No';
  end;
...
{ ╔═══════════════════════════════════════════════════════════════════════════╗
  ...
  {╔═════════════════════════════════════╗}
  {║} RT_RCDATA._then(procedure() Begin {║} {>>> LoadFromResourceName('rcdata.ext') <<<}
  {╚═════════════════════════════════════╝}
  ...
  img_.setAttribute('src', LoadFromResourceName('assets/nintendo1.svg'));
  ...
  img_0.setAttribute('src', LoadFromResourceName('assets/peixeA.png'));
  ...
  img_1.setAttribute('src', LoadFromResourceName('assets/peixeB.png'));
  ...
  img_2.setAttribute('src', LoadFromResourceName('assets/pas2js.png'));
  ...
  img_3.setAttribute('src', LoadFromResourceName('assets/undersea.jpg'));
  ...
  img_4.setAttribute('src', LoadFromResourceName('assets/fishfacts.png'));
  ...
  img_5.setAttribute('src', LoadFromResourceName('assets/tomate.png'));
...
//  result := JSON.parse(fishJsonData);
  Result := TJSObject(TJSJSON.parse(fishJsonData));
end;
...
//  pictureImg.setAttribute('src', 'pics/' + fishRecord.Species_No +'.png');
   pictureImg.setAttribute('src', LoadFromResourceName('pics/' + Self.fishRecord.Species_No +'.png') );
{╔═════════════════════════════════════╗}
{║} End);                             {║} {>>> end RT_RCDATA block <<<}
{╚═════════════════════════════════════╝}
