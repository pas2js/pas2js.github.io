...
rtl.module("Generics.Defaults",["System","Classes","Math"],function () {
  "use strict";
  var $mod = this;
  rtl.createInterface($mod,"IComparer$G10","{4D5A6C4F-61F6-30BA-A3EA-DEDC12CE3A10}",["Compare"],pas.System.IUnknown);
  rtl.createClass($mod,"TComparer$G9",pas.System.TInterfacedObject,function () {
    this.Construct = function (AComparison) {
      var Result = null;
      var $ok = false;
      try {
        Result = rtl.setIntfL(Result,rtl.queryIntfT($mod.TDelegatedComparerFunc$G9.$create("Create",[AComparison]),$mod.IComparer$G10),true);
        $ok = true;
      } finally {
  ...
  rtl.createClass($mod,"TDelegatedComparerFunc$G9",$mod.TComparer$G9,function () {
    this.$init = function () {
      $mod.TComparer$G9.$init.call(this);
      this.FComparison = null;
    };
    this.$final = function () {
      this.FComparison = undefined;
      $mod.TComparer$G9.$final.call(this);
    };
    ...
    this.Create = function (AComparison) {
...
rtl.module("Generics.Collections",["System","Classes","JS","Generics.Strings","Generics.Defaults"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TCustomArrayHelper$G5",pas.System.TObject,function () {
    this.Sort = function (AValues, AComparer) {
      this.QuickSort(AValues,0,rtl.length(AValues.get()) - 1,AComparer);
    };
  });
  rtl.createClass($mod,"TArrayHelper$G4",$mod.TCustomArrayHelper$G5,function () {
...
rtl.module("program",["System","JS","Classes","Types","Math","Generics.Collections","Generics.Defaults","Generics.Strings"],function () {
  "use strict";
  var $mod = this;
  this.PrintMatrix = function (A) {
    var i = 0;
    var j = 0;
    for (var $l1 = 0, $end2 = rtl.length(A) - 1; $l1 <= $end2; $l1++) {
      i = $l1;
      for (var $l3 = 0, $end4 = rtl.length(A[0]) - 1; $l3 <= $end4; $l3++) {
        j = $l3;
        pas.System.Write(A[i][j]," ");
      };
      pas.System.Writeln();
    };
    pas.System.Writeln();
  ...
  this.CustomCompare1 = function (Left, Right) {
    var Result = 0;
    Result = Right[0] - Left[0];
    return Result;
  };
  this.CustomCompare2 = function (Left, Right) {
    var Result = 0;
    var i = 0;
    i = 0;
    do {
      ...
      i += 1;
    } while (!((Result !== 0) || (i === rtl.length(Left))));
    return Result;
  };
  this.A = [];
  this.i = 0;
  ...
  $mod.$main = function () {
    ...
    try {
      pas.System.Writeln("Working with TArray - a two-dimensional integer array");
      pas.System.Writeln();
      $mod.A = rtl.arraySetLength($mod.A,0,4,7);
      Math.random();
      for (var $l1 = 0, $end2 = rtl.length($mod.A) - 1; $l1 <= $end2; $l1++) {
        $mod.i = $l1;
        for (var $l3 = 0, $end4 = rtl.length($mod.A[0]) - 1; $l3 <= $end4; $l3++) {
          $mod.j = $l3;
          $mod.A[$mod.i][$mod.j] = pas.Math.RandomRange(1,50);
        };
      };
      $mod.A[1][0] = $mod.A[0][0];
      $mod.A[2][0] = $mod.A[0][0];
      $mod.A[1][1] = $mod.A[0][1];
      pas.System.Writeln("The original array:");
      $mod.PrintMatrix($mod.A);
      pas["Generics.Collections"].TArrayHelper$G4.Sort({p: $mod, get: function () {
          return this.p.A;
        }, set: function (v) {
          this.p.A = v;
        }},$ir.ref(1,pas["Generics.Defaults"].TComparer$G9.Construct($mod.CustomCompare1)));
      pas.System.Writeln("Descending in column 1:");
      $mod.PrintMatrix($mod.A);
      pas["Generics.Collections"].TArrayHelper$G4.Sort({p: $mod, get: function () {
          return this.p.A;
        }, set: function (v) {
          this.p.A = v;
        }},$ir.ref(2,pas["Generics.Defaults"].TComparer$G9.Construct($mod.CustomCompare2)));
      pas.System.Writeln("Cascade sorting, starting from the 1st column:");
      $mod.PrintMatrix($mod.A);
    } finally {
      $ir.free();
    };
...
//# sourceMappingURL=tarrayprojectdouble.js.map
