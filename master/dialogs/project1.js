...
rtl.module("WEBLib.Dialogs",["System","Classes","SysUtils","Web","WEBLib.Controls","WEBLib.Forms"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  ...
  rtl.createClass($mod,"TMessageDlg",pas["WEBLib.Controls"].TCustomControl,function () {
    ...
    this.CreateButton = function (Caption) {
      ...
      Result.id = Caption;
      Result.addEventListener("click",rtl.createCallback(Self,"HandleButtonClick"));
      Result.addEventListener("keydown",rtl.createCallback(Self,"HandleKeyDown"));
      window.setTimeout(Hnd,1);
      return Result;
    };
    this.HandleButtonClick = function (Event) {
      ...
      if ($tmp1 === "Yes") {
       ...
       else if ($tmp1 === "NoToAll") {
        this.SetDialogResult(13)}
       else if ($tmp1 === "YesToAll") {
        this.SetDialogResult(14)}
       else if ($tmp1 === "Help") {
        this.SetDialogResult(9)}
       else if ($tmp1 === "Close") this.SetDialogResult(8);
    ...
    this.Close = function () {
      ...
      pas["WEBLib.Forms"].Application.PopForm();
    ...
    this.Show = function () {
      ...
      eh.style.setProperty("opacity","0.2");
      eh.style.setProperty("top","0");
      eh.style.setProperty("left","0");
      eh.style.setProperty("right","0");
      eh.style.setProperty("bottom","0");
    ...
    this.ShowDialog = function (Msg, DlgType, Buttons, AProc) {
      var Result = 0;
  ...
  this.MessageDlg = function (Msg, DlgType, Buttons, AResultProc) {
    ...
    $impl.WebLibDlg.ShowDialog(Msg,DlgType,rtl.refSet(Buttons),AResultProc);
    return Result;
  };
},null,function () {
  "use strict";
...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms","WEBLib.Dialogs"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    ...
    this.LoadDFMValues = function () {
      ...
      this.WebListBox2 = pas["WEBLib.StdCtrls"].TListBox.$create("Create$1",[this]);
      ...
      try {
        ...
        this.WebLabel4.SetLeft(48);
        this.WebLabel4.SetTop(16);
        this.WebLabel4.SetWidth(179);
        this.WebLabel4.SetHeight(23);
        this.WebLabel4.SetCaption("MessageDialog Demo");
        this.WebLabel4.FFont.FCharset = 1;
        this.WebLabel4.FFont.SetColor(0);
        this.WebLabel4.FFont.SetHeight(-19);
        this.WebLabel4.FFont.SetName("Tahoma");
        this.WebLabel4.FFont.SetStyle({});
        this.WebLabel4.FParentFont = false;
        this.WebLabel1.SetParent(this);
        this.WebLabel1.SetName("WebLabel1");
        this.WebLabel1.SetLeft(187);
        this.WebLabel1.SetTop(114);
        this.WebLabel1.SetWidth(40);
        this.WebLabel1.SetHeight(16);
        this.WebLabel1.SetCaption("Result:");
        this.WebLabel1.FFont.FCharset = 1;
        this.WebLabel1.FFont.SetColor(0);
        this.WebLabel1.FFont.SetHeight(-13);
        this.WebLabel1.FFont.SetName("Tahoma");
        this.WebLabel1.FFont.SetStyle({});
        this.WebLabel1.FParentFont = false;
        this.WebLabel2.SetParent(this);
        this.WebLabel2.SetName("WebLabel2");
        this.WebLabel2.SetLeft(243);
        this.WebLabel2.SetTop(114);
        this.WebLabel2.SetWidth(134);
        ...
        this.WebLabel2.FFont.SetHeight(-13);
        this.WebLabel2.FFont.SetName("Tahoma");
        this.WebLabel2.FFont.SetStyle({});
        this.WebLabel2.FParentFont = false;
        this.WebListBox2.SetParent(this);
        this.WebListBox2.SetName("WebListBox2");
        this.WebListBox2.SetLeft(48);
        this.WebListBox2.SetTop(114);
        this.WebListBox2.SetWidth(121);
        this.WebListBox2.SetHeight(97);
        this.WebListBox2.SetItemIndex(0);
        this.WebListBox2.FItems.BeginUpdate();
        try {
          this.WebListBox2.FItems.Clear();
          this.WebListBox2.FItems.Add("Warning");
          this.WebListBox2.FItems.Add("Error");
          this.WebListBox2.FItems.Add("Information");
          this.WebListBox2.FItems.Add("Confirmation");
          this.WebListBox2.FItems.Add("Custom");
        } finally {
          this.WebListBox2.FItems.EndUpdate();
        };
        this.WebListBox2.SetTabOrder(0);
        this.WebButton1.SetParent(this);
        this.WebButton1.SetName("WebButton1");
        this.WebButton1.SetLeft(48);
        this.WebButton1.SetTop(217);
        this.WebButton1.SetWidth(121);
        this.WebButton1.SetHeight(25);
        this.WebButton1.SetCaption("Show message");
        ...
        this.WebEdit1.SetLeft(48);
        this.WebEdit1.SetTop(87);
        this.WebEdit1.SetWidth(329);
        this.WebEdit1.SetHeight(24);
        this.WebEdit1.SetTabOrder(2);
        this.WebEdit1.SetText("Sample message text");
        this.WebPanel1.SetParent(this);
        this.WebPanel1.SetName("WebPanel1");
        this.WebPanel1.SetLeft(40);
        this.WebPanel1.SetTop(287);
        ...
        this.WebLabel6.SetLeft(6);
        this.WebLabel6.SetTop(29);
        this.WebLabel6.SetWidth(297);
        this.WebLabel6.SetHeight(32);
        this.WebLabel6.SetCaption("Demo showing various custom dialog types and the dialog response codes");
    ...
    this.WebButton1Click = function (Sender) {
      ...
      function DialogProc(AValue) {
        ...
        if ($tmp1 === 1) {
          ...
          s = "Close clicked"}
         else if ($tmp1 === 2) s = "Cancelled";
        Self.WebLabel2.SetCaption(s);
      };
      window.console.log("button clicked");
      var $tmp1 = Self.WebListBox2.GetItemIndex();
      if ($tmp1 === 0) {
        pas["WEBLib.Dialogs"].MessageDlg(Self.WebEdit1.GetText(),pas["WEBLib.Dialogs"].TMsgDlgType.mtWarning,{},DialogProc)}
       else if ($tmp1 === 1) {
        pas["WEBLib.Dialogs"].MessageDlg(Self.WebEdit1.GetText(),pas["WEBLib.Dialogs"].TMsgDlgType.mtError,{},DialogProc)}
       else if ($tmp1 === 2) {
        pas["WEBLib.Dialogs"].MessageDlg(Self.WebEdit1.GetText(),pas["WEBLib.Dialogs"].TMsgDlgType.mtInformation,{},DialogProc)}
       else if ($tmp1 === 3) {
        pas["WEBLib.Dialogs"].MessageDlg(Self.WebEdit1.GetText(),pas["WEBLib.Dialogs"].TMsgDlgType.mtConfirmation,rtl.createSet(pas["WEBLib.Dialogs"].TMsgDlgBtn.mbYes,pas["WEBLib.Dialogs"].TMsgDlgBtn.mbNo,pas["WEBLib.Dialogs"].TMsgDlgBtn.mbCancel),DialogProc)}
       else if ($tmp1 === 4) pas["WEBLib.Dialogs"].MessageDlg(Self.WebEdit1.GetText(),pas["WEBLib.Dialogs"].TMsgDlgType.mtCustom,rtl.createSet(pas["WEBLib.Dialogs"].TMsgDlgBtn.mbAbort,pas["WEBLib.Dialogs"].TMsgDlgBtn.mbRetry,pas["WEBLib.Dialogs"].TMsgDlgBtn.mbClose),DialogProc);
    };
  });
  this.Form1 = null;
});
