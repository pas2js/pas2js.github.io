...
rtl.module("i18next",["System","Classes","JS","Web"],function () {
  "use strict";
  var $mod = this;
});
rtl.module("program",["System","Classes","JS","Web","i18next"],function () {
  "use strict";
  var $mod = this;
  this.opt = null;
  this.i18nList = null;
  this.select = null;
  this.vCallback = function (currentValue, currentIndex, list) {
    currentValue.innerText = i18n.t(currentValue.dataset.i18n);
  };
  this.aCallBack = function (error, t) {
    $mod.i18nList.forEach($mod.vCallback);
  };
  this.EventHandler = function (Event) {
    var selecionada = null;
    var lng = "";
    selecionada = this.options.item(this.selectedIndex);
    lng = selecionada.getAttribute("value");
    $mod.opt = new Object();
    $mod.opt.lng = lng;
    i18n.init($mod.opt,$mod.aCallBack);
  };
  $mod.$main = function () {
    window.console.log("Program startup...");
    $mod.opt = new Object();
    $mod.opt.lng = "en";
    $mod.opt.resGetPath = "locales\/__lng__.jrs";
    i18n.init($mod.opt);
    $mod.i18nList = document.querySelectorAll("[data-i18n]");
    $mod.i18nList.forEach($mod.vCallback);
    $mod.select = document.querySelector("select");
    $mod.select.addEventListener("change",$mod.EventHandler);
