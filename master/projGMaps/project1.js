...
rtl.module("uGoogleMaps",["System","JS","Web"],function () {
  "use strict";
  var $mod = this;
});
rtl.module("program",["System","JS","Web","uGoogleMaps"],function () {
  "use strict";
  var $mod = this;
  this.loadMap = function (event) {
    ...
    window.console.log("Seven Lakes Map");
    mapOptions = {};
    mapOptions.zoom = 16;
    mapOptions.center = new google.maps.LatLng(-19.4574,-44.2417,false);
    mapOptions.mapTypeId = google.maps.MapTypeId.ROADMAP;
    map = new google.maps.Map(document.querySelector("#sample"),mapOptions);
    markerOptions = {};
    markerOptions.position = new google.maps.LatLng(-19.4574,-44.2417,false);
    beachMarker = new google.maps.Marker(markerOptions);
  ...
  this.InjectJS = function () {
    ...
    script.addEventListener("load",$mod.loadMap);
