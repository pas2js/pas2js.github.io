...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.Forms"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    ...
    this.LoadDFMValues = function () {
      ...
      this.WebLabel1 = pas["WEBLib.StdCtrls"].TLabel.$create("Create$2",["lbl"]);
      this.WebEdit1 = pas["WEBLib.StdCtrls"].TEdit.$create("Create$2",["edt"]);
      this.WebButton1 = pas["WEBLib.StdCtrls"].TButton.$create("Create$2",["btn"]);
      this.WebMemo1 = pas["WEBLib.StdCtrls"].TMemo.$create("Create$2",["mem"]);
      this.WebComboBox1 = pas["WEBLib.StdCtrls"].TComboBox.$create("Create$2",["sel"]);
      ...
      try {
        ...
        this.WebEdit1.SetCharCase(pas["WEBLib.StdCtrls"].TEditCharCase.wecLowerCase);
        ...
        this.WebComboBox1.SetTop(191);
        this.WebComboBox1.SetWidth(211);
