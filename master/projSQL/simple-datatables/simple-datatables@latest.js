        ...
        2: [function(t, e, s) {
            ...
            class c {
                ...
                order(t) {
                    ...
                    t.forEach((t, i) => {
                        ...
                        i = e.cloneNode(!1), a = e.cloneNode(!1), i.dataIndex = a.dataIndex = s, null !== e.searchIndex && void 0 !== e.searchIndex && (i.searchIndex = a.searchIndex = e.searchIndex), t.forEach(t => {
                            (h = e.cells[t].cloneNode(!0)).data = e.cells[t].data, i.appendChild(h), l.hiddenColumns.includes(t) || ((h = e.cells[t].cloneNode(!0)).data = e.cells[t].data, a.appendChild(h))
                        }), o[2].push(i), o[3].push(a)
                    }), l.columns = o[0], l.activeHeadings = o[1], l.data = o[2], l.activeRows = o[3], l.update()
                }
                hide(t) {
                    if (t.length) {
                        const e = this.dt;
                ...
                visible(t) {
                    let e;
                    const s = this.dt;
                    return t = t || s.data.map(t => t.originalCellIndex), isNaN(t) ? Array.isArray(t) && (e = [], t.forEach(t => {
            ...
            class f {
                constructor(t, e = {}) {
                    if (this.initialized = !1, this.options = {
                        ...
                        }, "string" == typeof t && (t = document.querySelector(t)), this.initialLayout = t.innerHTML, this.initialSortable = this.options.sortable, this.options.header || (this.options.sortable = !1), null === t.tHead && (!this.options.data || this.options.data && !this.options.data.columns) && (this.options.sortable = !1), t.tBodies.length && !t.tBodies[0].rows.length && this.options.data && !this.options.data.data) throw new Error("You seem to be using the data option, but you've not defined any rows.");
                            ...
                            a = e => {
                                if (4 === s.readyState)
                                    if (this.emit("datatable.ajax.loaded", e, s), 200 === s.status) {
                                        const i = {};
                                        i.data = t.load ? t.load.call(this, s) : s.responseText, i.type = "json", t.content && t.content.type && (i.type = t.content.type, Object.assign(i, t.content)), this.import(i), this.setColumns(!0), this.emit("datatable.ajax.success", e, s)
                ...
                renderPage() {
                    ...
                    let t, e = 0,
                        s = 0,
                        i = 0;
                    if (this.totalPages && (i = (s = (e = this.currentPage - 1) * this.options.perPage) + this.pages[e].length, s += 1, t = this.searching ? this.searchData.length : this.data.length), this.label && this.options.labels.info.length) {
                    ...
                    if (i(t)) {
                        if (t.columns && !this.hasHeadings && !this.hasRows) {
                            ...
                            t.columns.forEach(t => {
                                ...
                                e.appendChild(s)
                            }), this.head.appendChild(e), this.header = e, this.columns = [].slice.call(e.cells), this.hasHeadings = !0, this.options.sortable = this.initialSortable, this.render("header"), this.activeHeadings = this.columns.slice()
                        }
