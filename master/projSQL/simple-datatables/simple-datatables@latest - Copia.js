    ...
    return function() {
        ...
        1: [function(t, e, s) {
            (function(t) {
                ...
                var i = e(function(t, e) {
                        t.exports = function() {
                                ...
                                u = {
                                    ...
                                    z: function(t) {
                                        var e = -t.utcOffset(),
                                            ...
                                            i = Math.floor(s / 60),
                                            a = s % 60;
                                        return (e <= 0 ? "+" : "-") + c(i, 2, "0") + ":" + c(a, 2, "0")
                                    },
                                    m: function(t, e) {
                                        var s = 12 * (e.year() - t.year()) + (e.month() - t.month()),
                                            i = t.clone().add(s, r),
                                            a = e - i < 0,
                                            n = t.clone().add(s + (a ? -1 : 1), r);
                                        return Number(-(s + (e - i) / (a ? i - n : n - i)) || 0)
                                    },
                                    a: function(t) {
                            ...
                            var m = function(t) {
                                ...
                                y = function(t, e, s) {
                                    ...
                                    return i.date = t, new w(i)
                                },
                                v = u;
                            v.l = b, v.i = m, v.w = function(t, e) {
                                return y(t, {
                                    locale: e.$L,
                                    utc: e.$u
                                })
                                ...
                                return u.parse = function(t) {
                                    this.$d = function(t) {
                                        ...
                                        if ("string" == typeof e && !/Z$/i.test(e)) {
                                            var i = e.match(l);
                                            if (i) return s ? new Date(Date.UTC(i[1], i[2] - 1, i[3] || 1, i[4] || 0, i[5] || 0, i[6] || 0, i[7] || 0)) : new Date(i[1], i[2] - 1, i[3] || 1, i[4] || 0, i[5] || 0, i[6] || 0, i[7] || 0)
                                        }
                                        return new Date(e)
                                    }(t), this.init()
                                }, u.init = function() {
                                    ...
                                    return this.$g(t, "$s", e)
                                }, u.millisecond = function(e) {
                                    return this.$g(e, "$ms", t)
                                }, u.unix = function() {
                                    return Math.floor(this.valueOf() / 1e3)
                                }, u.valueOf = function() {
                                    return this.$d.getTime()
                                }, u.startOf = function(t, h) {
                                    var l = this,
                                        d = !!v.u(h) || h,
                                        c = v.p(t),
                                        u = function(t, e) {
                                            var s = v.w(l.$u ? Date.UTC(l.$y, e, t) : new Date(l.$y, e, t), l);
                                            return d ? s : s.endOf(a)
                                        },
                                        p = function(t, e) {
                                            return v.w(l.toDate()[t].apply(l.toDate(), (d ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), l)
                                        },
                                        f = this.$W,
                                        g = this.$M,
                                        m = this.$D,
                                    ...
                                    var l, d = v.p(n),
                                        c = "set" + (this.$u ? "UTC" : ""),
                                        u = (l = {}, l[a] = c + "Date", l.date = c + "Date", l[r] = c + "Month", l[o] = c + "FullYear", l[i] = c + "Hours", l[s] = c + "Minutes", l[e] = c + "Seconds", l[t] = c + "Milliseconds", l)[d],
                                        p = d === a ? this.$D + (h - this.$W) : h;
                                    if (d === r || d === o) {
                                        var f = this.clone().set("date", 1);
                                        f.$d[u](p), f.init(), this.$d = f.set("date", Math.min(this.$D, f.daysInMonth())).toDate()
                                    } else u && this.$d[u](p);
                                    ...
                                    var s = t || "YYYY-MM-DDTHH:mm:ssZ",
                                        ...
                                        f = {
                                            ...
                                            M: h + 1,
                                            MM: v.s(h + 1, 2, "0"),
                                            MMM: c(a.monthsShort, h, l, 3),
                                            MMMM: l[h] || l(this, s),
                                            D: this.$D,
                                            DD: v.s(this.$D, 2, "0"),
                                            d: String(this.$W),
                                            dd: c(a.weekdaysMin, this.$W, o, 2),
                                            ddd: c(a.weekdaysShort, this.$W, o, 3),
                                            dddd: o[this.$W],
                                            H: String(n),
                                            HH: v.s(n, 2, "0"),
                                            h: u(1),
                                    ...
                                    return s.replace(d, function(t, e) {
                                        return e || f[t] || i.replace(":", "")
                                    })
                                }, u.utcOffset = function() {
                                    return 15 * -Math.round(this.$d.getTimezoneOffset() / 15)
                                }, u.diff = function(t, l, d) {
                                    var c, u = v.p(l),
                                        p = y(t),
                                        f = 6e4 * (p.utcOffset() - this.utcOffset()),
                                        g = this - p,
                                        m = v.m(this, p);
                                    return m = (c = {}, c[o] = m / 12, c[r] = m, c[h] = m / 3, c[n] = (g - f) / 6048e5, c[a] = (g - f) / 864e5, c[i] = g / 36e5, c[s] = g / 6e4, c[e] = g / 1e3, c)[u] || g, d ? m : v.a(m)
                    ...
                    a = e(function(t, e) {
                        var s, i, a, n, r, h, o, l, d;
                        t.exports = (i = /(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, r = /\d*[^\s\d-:\/.()]+/, o = [/[+-]\d\d:?\d\d/, function(t) {
                            var e, s;
                            (this.zone || (this.zone = {})).offset = 0 == (s = 60 * (e = t.match(/([+-]|\d\d)/g))[1] + +e[2]) ? 0 : "+" === e[0] ? -s : s
                        }], l = {
                            A: [/[AP]M/, function(t) {
                                this.afternoon = "PM" === t
                            }],
                            ...
                            Do: [r, function(t) {
                                var e = s.ordinal,
                                    i = t.match(/\d+/);
                                if (this.day = i[0], e)
                                    for (var a = 1; a <= 31; a += 1) e(a).replace(/\[|\]/g, "") === t && (this.day = a)
                            }],
                            M: [n, h("month")],
                            MM: [a, h("month")],
                            MMM: [r, function(t) {
                            ...
                            try {
                                var a = function(t) {
                                        for (var e = t.match(i), s = e.length, a = 0; a < s; a += 1) {
                                            var n = e[a],
                                                r = l[n],
                                                h = r && r[0],
                                                o = r && r[1];
                                    ...
                                    u = a.milliseconds,
                                    p = a.zone;
                                if (p) return new Date(Date.UTC(n, r - 1, h, o || 0, d || 0, c || 0, u || 0) + 60 * p.offset * 1e3);
                                var f = new Date,
                                    g = n || f.getFullYear(),
                                    m = r > 0 ? r - 1 : f.getMonth(),
                                    b = h || f.getDate(),
                                    y = o || 0,
                                    v = d || 0,
                                    w = c || 0,
                                    C = u || 0;
                                return s ? new Date(Date.UTC(g, m, b, y, v, w, C)) : new Date(g, m, b, y, v, w, C)
                            } catch (t) {
                                return new Date("")
                            }
                        }, function(t, e, i) {
                            ...
                            a.parse = function(t) {
                                var e = t.date,
                                    ...
                                    r = t.pl,
                                    h = t.utc;
                                this.$u = h, a ? (s = r ? i.Ls[r] : this.$locale(), this.$d = d(e, a, h), this.init(t)) : n.call(this, t)
                            }
                        })
                    });
                i.extend(a);
        ...
        2: [function(t, e, s) {
            ...
            const i = t => "[object Object]" === Object.prototype.toString.call(t),
                ...
                r = t => {
                    t instanceof NodeList ? t.forEach(t => r(t)) : t.innerHTML = ""
                },
                h = (t, e, s) => n("li", {
                    class: t,
            ...
            class d {
                ...
                build(t) {
                    const e = n("tr");
                    let s = this.dt.columns;
                    return s.length || (s = t.map(() => "")), s.forEach((s, i) => {
                        const a = n("td");
                        t[i] && t[i].length || (t[i] = ""), a.innerHTML = t[i], a.values = t[i], e.appendChild(a)
                    }), e
                }
                render(t) {
                    return t
                ...
                add(t) {
                    if (Array.isArray(t)) {
                        ...
                        Array.isArray(t[0]) ? t.forEach(t => {
                            e.values.push(this.build(t))
                        }) : e.values.push(this.build(t)), e.values.length && (e.hasRows = !0), this.update(), e.columns().rebuild()
                    }
                }
                remove(t) {
                    const e = this.dt;
                    Array.isArray(t) ? (t.sort((t, e) => e - t), t.forEach(t => {
                        e.values.splice(t, 1)
                    })) : "all" == t ? e.values = [] : e.values.splice(t, 1), e.values.length || (e.hasRows = !1), this.update(), e.columns().rebuild()
                }
                update() {
                    this.dt.values.forEach((t, e) => {
                        t.dtaIndex = e
                    })
                }
            }
            class c {
                ...
                order(t) {
                    ...
                    const o = [
                        ...
                        l = this.dt;
                    t.forEach((t, i) => {
                        n = l.columns[t], r = "false" !== n.getAttribute("data-sortable"), (e = n.cloneNode(!0)).originalCellIndex = i, e.sortable = r, o[0].push(e), l.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)).originalCellIndex = i, s.sortable = r, o[1].push(s))
                    }), l.values.forEach((e, s) => {
                        i = e.cloneNode(!1), a = e.cloneNode(!1), i.dtaIndex = a.dtaIndex = s, null !== e.searchIndex && void 0 !== e.searchIndex && (i.searchIndex = a.searchIndex = e.searchIndex), t.forEach(t => {
                            (h = e.cells[t].cloneNode(!0)).values = e.cells[t].values, i.appendChild(h), l.hiddenColumns.includes(t) || ((h = e.cells[t].cloneNode(!0)).values = e.cells[t].values, a.appendChild(h))
                        }), o[2].push(i), o[3].push(a)
                    }), l.columns = o[0], l.activeHeadings = o[1], l.values = o[2], l.activeRows = o[3], l.update()
                }
                hide(t) {
                    if (t.length) {
                        const e = this.dt;
                ...
                visible(t) {
                    let e;
                    const s = this.dt;
                    return t = t || s.columns.map(t => t.originalCellIndex), isNaN(t) ? Array.isArray(t) && (e = [], t.forEach(t => {
                ...
                add(t) {
                    ...
                    if (!this.dt.columns.length) return this.dt.insert({
                        columns: [t.heading],
                        values: t.values.map(t => [t])
                    }), void this.rebuild();
                    this.dt.hiddenHeader ? s.innerHTML = "" : t.heading.nodeName ? s.appendChild(t.heading) : s.innerHTML = t.heading, this.dt.columns.push(s), this.dt.values.forEach((s, i) => {
                        t.values[i] && (e = document.createElement("td"), t.values[i].nodeName ? e.appendChild(t.values[i]) : e.innerHTML = t.values[i], e.values = e.innerHTML, t.render && (e.innerHTML = t.render.call(this, e.values, e, s)), s.appendChild(e))
                ...
                remove(t) {
                    Array.isArray(t) ? (t.sort((t, e) => e - t), t.forEach(t => this.remove(t))) : (this.dt.columns.splice(t, 1), this.dt.values.forEach(e => {
                ...
                filter(t, e, s, i) {
                    ...
                    a.values = r, this.rebuild(), a.update(), s || a.emit("datatable.sort", t, e)
                }
                sort(e, s, i) {
                    const a = this.dt;
                    if (a.hasHeadings && (e < 0 || e > a.columns.length)) return !1;
                    const n = a.options.filters && a.options.filters[a.columns[e].textContent];
                    ...
                    if ("date" === u.getAttribute("data-type")) {
                        let e = !1;
                        u.hasAttribute("data-format") && (e = u.getAttribute("data-format")), p.push(new Promise(function(e) {
                            e(t("./date-4abbfef1.js"))
                        }).then(({
                            parseDate: t
                        }) => s => t(s, e)))
                    }
                    Promise.all(p).then(t => {
                        ...
                        }), s || (s = u.classList.contains("asc") ? "desc" : "asc"), "desc" == s ? (p = o(h, -1), f = o(l, -1), u.classList.remove("asc"), u.classList.add("desc")) : (p = o(l, 1), f = o(h, 1), u.classList.remove("desc"), u.classList.add("asc")), a.lastTh && u != a.lastTh && (a.lastTh.classList.remove("desc"), a.lastTh.classList.remove("asc")), a.lastTh = u, r = p.concat(f), a.values = [];
                        const g = [];
                        r.forEach((t, e) => {
                            a.values.push(t.row), null !== t.row.searchIndex && void 0 !== t.row.searchIndex && g.push(e)
                ...
                rebuild() {
                    ...
                    }), a.values.forEach((r, h) => {
                        t = r.cloneNode(!1), e = r.cloneNode(!1), t.dtaIndex = e.dtaIndex = h, null !== r.searchIndex && void 0 !== r.searchIndex && (t.searchIndex = e.searchIndex = r.searchIndex), Array.from(r.cells).forEach(n => {
                            (s = n.cloneNode(!0)).values = n.values, t.appendChild(s), a.hiddenColumns.includes(s.cellIndex) || ((i = s.cloneNode(!0)).values = s.values, e.appendChild(i))
            ...
            const u = function(t) {
                    let e = !1,
                        s = !1;
                    if ((t = t || this.options.data).columns) {
                        e = n("thead");
                        const s = n("tr");
                        t.columns.forEach(t => {
                            const e = n("th", {
                    ...
                    t.values && t.values.length && (s = n("tbody"), t.values.forEach(e => {
                        if (t.columns && t.columns.length !== e.length) throw new Error("The number of rows do not match the number of headings.");
                        const i = n("tr");
                        e.forEach(t => {
                            const e = n("td", {
                                html: t
            ...
            class f {
                constructor(t, e = {}) {
                    if (this.initialized = !1, this.options = {
                        ...
                        }, "string" == typeof t && (t = document.querySelector(t)), this.initialLayout = t.innerHTML, this.initialSortable = this.options.sortable, this.options.header || (this.options.sortable = !1), null === t.tHead && (!this.options.values || this.options.values && !this.options.values.columns) && (this.options.sortable = !1), t.tBodies.length && !t.tBodies[0].rows.length && this.options.values && !this.options.values.values) throw new Error("You seem to be using the data option, but you've not defined any rows.");
                    this.table = t, this.init()
                }
                static extend(t, e) {
                    "function" == typeof e ? f.prototype[t] = e : f[t] = e
                }
                init(t) {
                ...
                render(t) {
                    ...
                    if (e.data && u.call(this), e.ajax) {
                            ...
                            a = e => {
                                if (4 === s.readyState)
                                    if (this.emit("datatable.ajax.loaded", e, s), 200 === s.status) {
                                        const i = {};
                                        i.values = t.load ? t.load.call(this, s) : s.responseText, i.type = "json", t.content && t.content.type && (i.type = t.content.type, Object.assign(i, t.content)), this.import(i), this.setColumns(!0), this.emit("datatable.ajax.success", e, s)
                        ...
                        s.addEventListener("progress", i, !1), s.addEventListener("load", a, !1), s.addEventListener("error", n, !1), s.addEventListener("abort", r, !1), this.emit("datatable.ajax.loading", s), s.open("GET", "string" == typeof t ? e.ajax : e.ajax.url), s.send()
                    }
                    if (this.body = this.table.tBodies[0], this.head = this.table.tHead, this.foot = this.table.tFoot, this.body || (this.body = n("tbody"), this.table.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = n("thead"),
                            s = n("tr");
                    ...
                    if (this.headings = [], this.hasHeadings = this.head.rows.length > 0, this.hasHeadings && (this.header = this.head.rows[0], this.headings = [].slice.call(this.header.cells)), e.header || this.head && this.table.removeChild(this.table.tHead), e.footer ? this.head && !this.foot && (this.foot = n("tfoot", {
                            html: this.head.innerHTML
                        }), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot), this.wrapper = n("div", {
                ...
                renderPage() {
                    ...
                    let t, e = 0,
                        s = 0,
                        i = 0;
                    if (this.totalPages && (i = (s = (e = this.currentPage - 1) * this.options.perPage) + this.pages[e].length, s += 1, t = this.searching ? this.searchData.length : this.values.length), this.label && this.options.labels.info.length) {
                ...
                renderPager() {
                    if (r(this.pagers), this.totalPages > 1) {
                        const t = "pager",
                            e = document.createDocumentFragment(),
                        ...
                        let a = this.links;
                        this.options.truncatePager && (a = l(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)), this.links[this.currentPage - 1].classList.add("active"), a.forEach(t => {
                            t.classList.remove("active"), e.appendChild(t)
                        }), this.links[this.currentPage - 1].classList.add("active"), this.options.nextPrev && e.appendChild(h(t, i, this.options.nextText)), this.options.firstLast && e.appendChild(h(t, this.totalPages, this.options.lastText)), this.pagers.forEach(t => {
                ...
                bindEvents() {
                    ...
                    t.searchable && (this.input = this.wrapper.querySelector(".dataTable-input"), this.input && this.input.addEventListener("keyup", () => this.search(this.input.value), !1)), this.wrapper.addEventListener("click", e => {
                        const s = e.target;
                        "a" === s.nodeName.toLowerCase() && (s.hasAttribute("data-page") ? (this.page(s.getAttribute("data-page")), e.preventDefault()) : t.sortable && s.classList.contains("dataTable-sorter") && "false" != s.parentNode.getAttribute("data-sortable") && (this.columns().sort(this.columns.indexOf(s.parentNode)), e.preventDefault()))
                    }, !1), window.addEventListener("resize", () => {
                        this.rect = this.container.getBoundingClientRect(), this.fixColumns()
                    })
                }
                setColumns(t) {
                    t || this.values.forEach(t => {
                        Array.from(t.cells).forEach(t => {
                            t.values = t.innerHTML
                        })
                    }), this.options.headings && this.headings.length && this.options.headings.forEach(t => {
                    ...
                    }), this.hasRows && (this.values.forEach((t, e) => {
                        t.dtaIndex = e, Array.from(t.cells).forEach(t => {
                            t.values = t.innerHTML
                        })
                    }), this.selectedColumns.length && this.values.forEach(t => {
                        Array.from(t.cells).forEach((e, s) => {
                            this.selectedColumns.includes(s) && this.columnRenderers.forEach(i => {
                                i.columns.includes(s) && (e.innerHTML = i.renderer.call(this, e.values, e, t))
                            })
                        })
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.table.tHead) {
                            if (this.options.scrollY.length && ((e = n("thead")).appendChild(n("tr")), e.style.height = "0px", this.headerTable && (this.table.tHead = this.headerTable.tHead)), this.activeHeadings.forEach(t => {
                                    t.style.width = ""
                                }), this.activeHeadings.forEach((t, s) => {
                                    const i = t.offsetWidth,
                                        a = i / this.rect.width * 100;
                                    if (t.style.width = `${a}%`, this.columnWidths[s] = i, this.options.scrollY.length) {
                                        const t = n("th");
                                        e.firstElementChild.appendChild(t), t.style.width = `${a}%`, t.style.paddingTop = "0", t.style.paddingBottom = "0", t.style.border = "0"
                                    }
                                }), this.options.scrollY.length) {
                                const t = this.table.parentElement;
                                if (!this.headerTable) {
                                    this.headerTable = n("table", {
                ...
                search(t) {
                    return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = !0, this.searchData = [], t.length ? (this.clear(), this.values.forEach((e, s) => {
                        ...
                        t.split(" ").reduce((t, s) => {
                            ...
                            for (let t = 0; t < e.cells.length; t++)
                                if ((n = (a = e.cells[t]).hasAttribute("data-content") ? a.getAttribute("data-content") : a.textContent).toLowerCase().includes(s) && this.columns(a.cellIndex).visible()) {
                                    i = !0;
                                    break
                                } return t && i
                ...
                insert(t) {
                    let e = [];
                    if (i(t)) {
                        if (t.columns && !this.hasHeadings && !this.hasRows) {
                            const e = n("tr");
                            t.columns.forEach(t => {
                                const s = n("th", {
                                    html: t
                                ...
                                e.appendChild(s)
                            }), this.head.appendChild(e), this.header = e, this.headings = [].slice.call(e.cells), this.hasHeadings = !0, this.options.sortable = this.initialSortable, this.render("header"), this.activeHeadings = this.columns.slice()
                        }
                        t.values && Array.isArray(t.values) && (e = t.values)
                ...
                export (t) {
                    ...
                    if (l.type) {
                        ...
                        if (s.length) {
                                ...
                                for (h = "", n = 0; n < s.length; n++) {
                                    for (r = 0; r < s[n].cells.length; r++)
                                        if (!l.skipColumn.includes(e[r].originalCellIndex) && this.columns(e[r].originalCellIndex).visible()) {
                                            ...
                                            (t = (t = (t = (t = (t = t.trim()).replace(/\s{2,}/g, " ")).replace(/\n/g, "  ")).replace(/"/g, '""')).replace(/#/g, "%23")).includes(",") && (t = `"${t}"`), h += t + l.columnDelimiter
                            ...
                            return l.download && (l.filename = l.filename || "datatable_export", l.filename += `.${l.type}`, h = encodeURI(h), (o = document.createElement("a")).href = h, o.download = l.filename, document.body.appendChild(o), o.click(), document.body.removeChild(o)), h
                        }
                    }
                    return !1
                }
                import(t) {
                    ...
                    if (s.values.length || i(s.values)) {
                        if ("csv" === s.type) {
                            e = {
                                values: []
                            };
                            const t = s.values.split(s.lineDelimiter);
                            t.length && (s.columns && (e.columns = t[0].split(s.columnDelimiter), t.shift()), t.forEach((t, i) => {
                                e.values[i] = [];
                            ...
                            t && (e = {
                                ...
                                e.values[s] = [], Object.entries(t).forEach(([t, i]) => {
                                    e.columns.includes(t) || e.columns.push(t), e.values[s].push(i)
                                })
                            }))
                        }
                        i(s.values) && (e = s.values), e && this.insert(e)
                    }
                    return !1
                }
                print() {
                    ...
                    }), s.appendChild(i), s.appendChild(a);
                    const h = window.open();
                    h.document.body.appendChild(s), h.print()
                }
                setMessage(t) {
                    let e = 1;
                    this.hasRows ? e = this.values[0].cells.length : this.activeHeadings.length && (e = this.activeHeadings.length), this.wrapper.classList.add("dataTable-empty"), this.label && (this.label.innerHTML = ""), this.totalPages = 0, this.render("pager"), this.clear(n("tr", {
