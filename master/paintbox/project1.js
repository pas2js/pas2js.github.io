...
rtl.module("WEBLib.Graphics",["System","Classes","SysUtils","Types","contnrs","Web","JS"],function () {
  ...
  rtl.createClass($mod,"TFont",pas.Classes.TPersistent,function () {
    ...
    this.ToString = function () {
      ...
      Result = ((s + pas.SysUtils.FloatToStr($mod.FontSizeToPx(this.FSize))) + "px ") + this.FName;
      return Result;
    };
    var $r = this.$rtti;
  ...
  rtl.createClass($mod,"TCanvas",pas.System.TObject,function () {
    ...
    this.TextOut_ = function (X, Y, Text) {
      var f = "";
      var fc = "";
      if (this.FContext != null) {
        f = this.FFont.ToString();
        fc = $mod.ColorToHex(this.FFont.FColor);
        this.FContext.fillStyle = "#" + fc;
...
rtl.module("Unit1",["System","SysUtils","Classes","JS","Web","WEBLib.Graphics","WEBLib.Controls","WEBLib.StdCtrls","WEBLib.ExtCtrls","WEBLib.Forms"],function () {
  ...
  rtl.createClass($mod,"TForm1",pas["WEBLib.Forms"].TForm,function () {
    this.$init = function () {
      ...
      this.WebLabel1 = null;
      this.WebPaintBox1 = null;
      this.WebPanel1 = null;
      this.WebLabel2 = null;
      this.WebImageControl1 = null;
      this.WebPaintBox2 = null;
    };
    this.$final = function () {
      this.WebLabel1 = undefined;
      this.WebPaintBox1 = undefined;
      this.WebPanel1 = undefined;
      this.WebLabel2 = undefined;
      this.WebImageControl1 = undefined;
      this.WebPaintBox2 = undefined;
      pas["WEBLib.Forms"].TForm.$final.call(this);
    };
    this.WebPaintBox1Paint = function (Sender) {
      this.PaintSign(this.WebPaintBox1,"Native clients only",true);
    };
    this.WebPaintBox2Paint = function (Sender) {
      this.PaintSign(this.WebPaintBox2,"Web + Native clients!",false);
    };
    this.PaintSign = function (Control, AText, Cross) {
      Control.GetCanvas().FPen.FWidth = 3;
      Control.GetCanvas().FPen.SetColor(255);
      Control.GetCanvas().FBrush.FColor = 65535;
      Control.GetCanvas().FBrush.FStyle = pas["WEBLib.Graphics"].TBrushStyle.bsSolid;
      Control.GetCanvas().Rectangle(10,10,200,100);
      if (Cross) {
        Control.GetCanvas().MoveTo(10,100);
        Control.GetCanvas().LineTo(200,10);
        Control.GetCanvas().FFont.SetSize(14);
      };
      Control.GetCanvas().FFont.SetName("Arial");
      Control.GetCanvas().FFont.SetSize(14);
      Control.GetCanvas().TextOut(20,40,AText);
    };
    this.LoadDFMValues = function () {
      ...
      this.WebPaintBox1 = pas["WEBLib.ExtCtrls"].TPaintBox.$create("Create$1",[this]);
      ...
      this.WebPaintBox2 = pas["WEBLib.ExtCtrls"].TPaintBox.$create("Create$1",[this]);
      this.WebLabel1.BeginUpdate();
      this.WebPaintBox1.BeginUpdate();
      this.WebPanel1.BeginUpdate();
      this.WebLabel2.BeginUpdate();
      this.WebImageControl1.BeginUpdate();
      this.WebPaintBox2.BeginUpdate();
      try {
        this.SetName("Form1");
        this.SetLeft(0);
        this.SetTop(0);
        ...
        this.WebLabel1.SetWidth(533);
        this.WebLabel1.SetHeight(32);
        this.WebLabel1.SetCaption("Say good-bye to the world of native clients only. Welcome in the wonderful TMS Web world, bringing Delphi developers everywhere: native clients and web clients!");
        this.WebLabel1.FWordWrap = true;
        this.WebPaintBox1.SetParent(this);
        this.WebPaintBox1.SetName("WebPaintBox1");
        this.WebPaintBox1.SetLeft(64);
        this.WebPaintBox1.SetTop(87);
        this.WebPaintBox1.SetWidth(235);
        this.WebPaintBox1.SetHeight(137);
        this.WebPaintBox1.FOnPaint = rtl.createCallback(this,"WebPaintBox1Paint");
        ...
        this.WebLabel2.SetWidth(428);
        this.WebLabel2.SetHeight(32);
        this.WebLabel2.SetCaption("With Pascal code you can draw on the TPaintBox control using the familiar TCanvas object");
        ...
        this.WebPaintBox2.SetParent(this);
        this.WebPaintBox2.SetName("WebPaintBox2");
        this.WebPaintBox2.SetLeft(342);
        this.WebPaintBox2.SetTop(87);
        this.WebPaintBox2.SetWidth(235);
        this.WebPaintBox2.SetHeight(137);
        this.WebPaintBox2.FOnPaint = rtl.createCallback(this,"WebPaintBox2Paint");
      } finally {
        this.WebLabel1.EndUpdate();
        this.WebPaintBox1.EndUpdate();
        this.WebPanel1.EndUpdate();
        this.WebLabel2.EndUpdate();
        this.WebImageControl1.EndUpdate();
        this.WebPaintBox2.EndUpdate();
      };
    };
  });
  this.Form1 = null;
});
rtl.module("program",["System","JS","Classes","SysUtils","Web","WEBLib.Forms","Unit1"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
